...
# a unique "alpha_only" tool. Responds to all probes (scans cleanly).
import sys, json
def send(o): sys.stdout.write(json.dumps(o)+"\n"); sys.stdout.flush()
TOOLS = [
    {"name": "shared_tool", "description": "a shared tool name", "inputSchema": {"type": "object"}},
    {"name": "alpha_only", "description": "unique to A", "inputSchema": {"type": "object"}},
]
for line in sys.stdin:
    ...
    if mt == "initialize":
        send({"jsonrpc": "2.0", "id": mid, "result": {"protocolVersion": "2025-11-25", "capabilities": {"tools": {}}, "serverInfo": {"name": "shadow-a", "version": "1.0"}}})
