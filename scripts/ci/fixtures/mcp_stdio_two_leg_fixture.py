#!/usr/bin/env python3
# P2-15 fixture: a server with only two of the three lethal-trifecta legs
# (untrusted input + external comms, no private-data access). Rule of Two is
# satisfied, so SEC-LETHAL-TRIFECTA must NOT fire.
import sys, json
...
for line in sys.stdin:
    ...
    if mt == "initialize":
        send({"jsonrpc": "2.0", "id": mid, "result": {"protocolVersion": "2025-11-25", "capabilities": {"tools": {}}, "serverInfo": {"name": "two-leg", "version": "1.0"}}})
